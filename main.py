...
from core.config import AUTO_UNIVERSE, UNIVERSE_LIMIT, SYMBOLS as ENV_SYMS, WS_POLL_SEC, ORDER_VALUE_USDT, MAX_CONCURRENCY, H1_TTL_SEC, H4_TTL_SEC, ANALYZE_COOLDOWN_SEC, JITTER_SEC
...
async def main():
    ...
    # Bind WS handlers
    def on_trade(sym, d):
        # could feed advanced liq/impact logic here
        pass
    def on_bt(sym, d):
